...
#define ptt_tx_1 41 //13              // PTT ("push to talk") lines
#define ptt_tx_2 22              //   Can be used for keying fox transmitter, T/R switch, or keying slow boatanchors
...
// rotary encoder pins and options - rotary encoder code from Jim Balls M0CKE
  ...
  #define led_ring_sdi    A10     //Data
  #define led_ring_clk    A9     //Clock
  #define led_ring_le     A8     //Latch
